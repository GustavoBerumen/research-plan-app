...
const PUBLIC_ASSETS = new Map([
  ...
  ['/plan-document.js', 'plan-document.js'],
...
// Feedback on the tool from the review step (RPA-98): a score and two short
// answers, appended one line per submission. Nothing from the plan is
