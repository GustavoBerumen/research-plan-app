...
test('every free-text field says what remains, from the start, right under its box', async (t) => {
  ...
  const tiers = { background: 60, problemStatement: 60, comments: 60, goal: 30, objective: 30, hypothesis: 30 };
  ...
  assert.equal(d.querySelectorAll('.word-count').length, 6, 'and nowhere else');
