...
test('every step prints, and the step chrome does not', () => {
  ...
  assert.match(print, /\.step-top,\.step-nav,\.task-list-step,\.start-step,\.email-step,\.dead-link,\.check-answers,\.review-answers,\.tool-feedback,\.error-summary,\.field-error\{display:none!important\}/);
});
