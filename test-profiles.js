  ...
  window.TEST_PROFILES = Object.freeze({
    experienced: {
      ...
      fields: {
        ...
        problemStatement: 'New mobile shoppers abandon 68% of checkout sessions while selecting a payment method or entering billing details, costing approximately 1,200 orders per month. This study will focus only on those two payment-step interactions.',
        ...
        researchQuestions: [
          'Which interactions while selecting a payment method or entering billing details cause new mobile shoppers to abandon checkout?',
          'How do new mobile shoppers interpret which payment options and billing fields are required to continue?',
        ],
        outcomes: [
          'A prioritised list of payment-step usability issues, mapped to the affected interaction and recommended Q4 design change.',
          'Evidence showing how shoppers interpret payment options and required billing fields, translated into copy and layout requirements for the Q4 redesign.',
        ],
      },
    },
    novice: {
      ...
      fields: {
        ...
        problemStatement: 'Users do not like the checkout and it is causing problems for the business.',
        ...
        researchQuestions: [
          'What do users think about the checkout?',
          'What would make the checkout better?',
        ],
        outcomes: [
          'A report with our findings.',
          'Some ideas for improving the checkout.',
        ],
      },
    },
  });
